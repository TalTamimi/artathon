...
axiom = 'F+++++GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG-----F+++++GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG-----F'
angle = 23
...
screen = pygame.display.set_mode(size,0, 32)  # open screen
screen.fill((255, 255, 255))

# startpos = 100, height - 225
# startpos = 50, height / 2 - 50
startpos = width / 2 - 200, height
...
if __name__ == '__main__':
    ...
    for i in range (1,7):
        tree = (createSystem(i, axiom))
        print( tree)
        drawTree(tree, startpos)

        pygame.display.flip()

        pygame.image.save(screen, "treetest"+str(i)+".png")
        screen.fill((255, 255, 255))
