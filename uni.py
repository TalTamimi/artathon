...
stars = [(random.randint(0, 699), random.randint(0, 200)) for x in range(140)]
...
while running:
    ...
    # draw the sun
    pygame.draw.circle(screen, grey, center, sun_radius)
    ...
    axiom = 'F+++++GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG-----F'
            # '+++++GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG-----F'
    tree = (lsystem.createSystem(4, axiom))
    lsystem.drawTree(tree, (150,700))
    pygame.display.flip()
